...
public class SwerveModule {
  ...
  private final PIDController m_turningPIDController = new PIDController(DTConstants.kPModuleTurningController, 0,
      0);
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    driveOutput = m_state.speedMetersPerSecond / DTConstants.kMaxSpeedMetersPerSecond;
